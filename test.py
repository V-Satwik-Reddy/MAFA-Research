...
def main():
    ...
    paths = {
        "MLP Advanced": os.path.join(base_dir,"results", args.ticker ,"test","mlp_pred.csv"),
        "LSTM Advanced": os.path.join(base_dir, "results", args.ticker ,"test","lstm_pred.csv"),
        "LSTM + News Advanced": os.path.join(base_dir, "results", args.ticker ,"test","lstm_news_pred.csv")
    }
    # print(paths)
    dfs = {}
